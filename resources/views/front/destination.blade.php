            ...
            <div class="col-lg-12 col-md-12">
                <div class="main-item mb_50">
                    <div class="main-photo">
                        <img src="{{ $destination->featured_photo }}" alt="{{$destination->featured_photo}}">
                    </div>
                </div>
                <div class="main-item mb_50">
                    <h2>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="item pb_25">
                                    <div class="photo">
                                                <a href="{{ route('package.show',$item->slug) }}"><img src="{{ $item->featured_photo }}" alt="{{$item->featured_photo}}"></a>
                                        <div class="wishlist">
                    ...
                    <div class="photo-all">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="item">
                                    <a href="{{ $photo->photo }}" class="magnific">
