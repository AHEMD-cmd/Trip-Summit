                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="text" name="name" class="form-control"
                                                placeholder="Package Name ..." value="{{ request()->name }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <select name="destination_id" class="form-select">
                                        ...
                                        @foreach ($destinations as $destination)
                                            <option value="{{ $destination->id }}"
                                                @if (request()->destination_id == $destination->id) selected @endif>
                                                {{ $destination->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="box">
                                    <div class="form-check form-check-review form-check-review-1">
                                        <input name="review" class="form-check-input" type="radio" id="reviewRadiosAll"
                                            value="" @if (request()->review == null) checked @endif>
                                    ...
                                    <div class="form-check form-check-review">
                                        <input name="review" class="form-check-input" type="radio" id="reviewRadios1"
                                            value="5" @if (request()->review == '5') checked @endif>
                                    ...
                                    <div class="form-check form-check-review">
                                        <input name="review" class="form-check-input" type="radio" id="reviewRadios2"
                                            value="4.5" @if (request()->review == '4.5') checked @endif>
                                    ...
                                    <div class="form-check form-check-review">
                                        <input name="review" class="form-check-input" type="radio" id="reviewRadios3"
                                            value="4" @if (request()->review == '4') checked @endif>
                                    ...
                                    <div class="form-check form-check-review">
                                        <input name="review" class="form-check-input" type="radio" id="reviewRadios4"
                                            value="3.5" @if (request()->review == '3.5') checked @endif>
                                    ...
                                    <div class="form-check form-check-review">
                                        <input name="review" class="form-check-input" type="radio" id="reviewRadios5"
                                            value="3" @if (request()->review == '3') checked @endif>
                                    ...
                                    <div class="form-check form-check-review">
                                        <input name="review" class="form-check-input" type="radio" id="reviewRadios6"
                                            value="2.5" @if (request()->review == '2.5') checked @endif>
                                    ...
                                    <div class="form-check form-check-review">
                                        <input name="review" class="form-check-input" type="radio" id="reviewRadios7"
                                            value="2" @if (request()->review == '2') checked @endif>
                                    ...
                                    <div class="form-check form-check-review">
                                        <input name="review" class="form-check-input" type="radio" id="reviewRadios8"
                                            value="1.5" @if (request()->review == '1.5') checked @endif>
                                    ...
                                    <div class="form-check form-check-review">
                                        <input name="review" class="form-check-input" type="radio" id="reviewRadios9"
                                            value="1" @if (request()->review == '1') checked @endif>
                        ...
                        @foreach ($packages as $item)
                            <div class="col-lg-6 col-md-6">
                                <div class="item pb_25">
                                    <div class="photo">
                                        <a href="{{ route('package.show', $item->slug) }}"><img
                                                src="{{ $item->featured_photo }}" alt="{{ $item->featured_photo }}"></a>
                                        <div class="wishlist">
                                    ...
                                    <div class="text">
                                        ...
                                        <div class="element">
                                            ...
                                            <div class="element-right">
                                                <i class="fas fa-th-large"></i> {{ $item->packageAmenities->count() }}
                                                Amenities
                                            </div>
                                        </div>
                                        <div class="element">
