                ...
                <div class="left-item">
                    ...
                    <div class="sub">
                        <ul>
                            ...
                            <li><i class="fas fa-th-large"></i> Category: <a href="{{ route('category',$post->category->slug) }}">{{ $post->category->name }}</a></li>
                        </ul>
                    </div>
            ...
            <div class="col-lg-4 col-md-12">
                <div class="right-item">
                    ...
                    <ul>
                        ...
                        <li><a href="{{ route('post.show',$post->slug) }}"><i class="fas fa-angle-right"></i> {{ $post->title }}</a></li>
                        @endforeach
                    </ul>
