...
<div class="page-top" style="background-image: url({{ $setting->banner }})">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h2>Invoice: {{ $booking->invoice_no }}</h2>
                <div class="breadcrumb-container">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
                        <li class="breadcrumb-item active">Invoice: {{ $booking->invoice_no }}</li>
                    </ol>
                </div>
            </div>
        </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered invoice-item-table">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>1</td>
                                                <td>{{ $booking->tour->package->name }}</td>
                                                <td>
                                                ...
                                                <td>${{ $booking->tour->package->price }}</td>
