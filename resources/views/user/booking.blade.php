                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="mb-3 row modal-seperator">
                                                        ...
                                                        <div class="col-md-7">
                                                            <b>Name:</b> {{ $booking->package->name }}<br>
                                                            <a href="{{ route('package.show', $booking->package->slug) }}"
                                                    ...
                                                    <div class="mb-3 row modal-seperator">
                                                        ...
                                                        <div class="col-md-7">
                                                            <b>Start Date: </b> {{ $booking->tour->tour_start_date }}<br>
                                                            <b>End Date: </b> {{ $booking->tour->tour_end_date }}<br>
                                                        </div>
                                                    </div>
                                                    <div class="mb-3 row modal-seperator">
                                                        <div class="col-md-5">
