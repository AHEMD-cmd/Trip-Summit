            ...
            <div class="section-body">
                <div class="row">
                                        ...
                                        <tbody>
                                            @foreach ($packagePhotos as $photo)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="{{ $photo->photo }}" alt="{{ $photo->photo }}" class="w_150">
                                                    </td>
                                                    <td>
                                                        <form
                                                            action="{{ route('packages.photos.destroy', ['package' => $package->id, 'photo' => $photo->id]) }}"
                    ...
                    <div class="col-md-5">
                        <div class="card">
                            <div class="card-body">
                                <form action="{{ route('packages.photos.store', $package->id) }}" method="post"
