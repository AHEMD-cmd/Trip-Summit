    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header justify-content-between">
                <h1>Edit Tour</h1>
                <div class="ml-auto">
                    <a href="{{ route('tours.index') }}" class="btn btn-primary"><i class="fas fa-plus"></i> View All</a>
                </div>
            </div>
                                                ...
                                                <select name="package_id" class="form-select">
                                                    @foreach ($packages as $package)
                                                        <option value="{{ $package->id }}"
                                                            @if ($tour->package_id == $package->id) selected @endif>
                                                            {{ $package->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input id="datepicker1" type="text" name="tour_start_date"
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input id="datepicker2" type="text" name="tour_end_date"
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input id="datepicker3" type="text" name="booking_end_date"
