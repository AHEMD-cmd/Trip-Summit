...
<div class="main-content">
    <section class="section">
        <div class="section-header justify-content-between">
            ...
            <div class="ml-auto">
                <a href="{{ route('destinations.index') }}" class="btn btn-primary"><i class="fas fa-plus"></i> View All</a>
            </div>
        </div>
                        ...
                        <div class="card-body">
                            <form action="{{ route('destinations.update', $destination->id) }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div><img src="{{ $destination->featured_photo }}" alt="{{$destination->name}}" class="w_200"></div>
                                </div>
                                <div class="mb-3">
